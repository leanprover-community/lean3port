...
unsafe inductive sf : Type
  ...
  | compose : sf → sf → sf
  | of_string : String → sf
#align widget.interactive_expression.sf widget.interactive_expression.sf
...
#align widget.interactive_expression.sf.of_eformat widget.interactive_expression.sf.of_eformat
...
#align widget.interactive_expression.sf.flatten widget.interactive_expression.sf.flatten
...
#align widget.interactive_expression.type_tooltip widget.interactive_expression.type_tooltip
...
#align widget.filter_type widget.filter_type
...
unsafe def filter_local : filter_type → expr → tactic Bool
  ...
  | filter_type.only_props, e => do
    let t ← tactic.infer_type e
    tactic.is_prop t
#align widget.filter_local widget.filter_local
  ...
  component.stateless fun lf =>
    [h "label" [] ["filter: "],
      select
        ...
        lf]
#align widget.filter_component widget.filter_component

unsafe def html.of_name {α : Type} : Name → html α
  | n => html.of_string <| Name.toString n
#align widget.html.of_name widget.html.of_name
...
unsafe def show_type_component : tc expr Empty :=
  tc.stateless fun x => do
    ...
    pure y_comp
#align widget.show_type_component widget.show_type_component
...
unsafe structure local_collection where
  ...
  type : expr
  deriving DecidableEq
#align widget.local_collection widget.local_collection
...
#align widget.tactic_view_goal widget.tactic_view_goal
...
#align widget.tactic_view_term_goal widget.tactic_view_term_goal
...
#align widget.tactic_state_widget widget.tactic_state_widget
...
#align widget.term_goal_widget widget.term_goal_widget
