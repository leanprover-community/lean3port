...
#align char.val_of_nat_eq_of_is_valid Char.val_of_nat_eq_of_is_valid

theorem val_of_nat_eq_of_not_is_valid {n : Nat} : ¬IsValidChar n → (ofNat n).val = 0 := by
  intro h <;> unfold of_nat <;> rw [dif_neg h]
#align char.val_of_nat_eq_of_not_is_valid Char.val_of_nat_eq_of_not_is_valid
...
theorem of_nat_ne_of_ne {n₁ n₂ : Nat} (h₁ : n₁ ≠ n₂) (h₂ : IsValidChar n₁) (h₃ : IsValidChar n₂) :
  ...
  assumption
#align char.of_nat_ne_of_ne Char.of_nat_ne_of_ne
