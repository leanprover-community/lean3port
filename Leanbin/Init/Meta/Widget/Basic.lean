...
unsafe instance attr.is_functor : Functor attr :=
  { map := @attr.map_action }

unsafe instance html.is_functor : Functor html :=
...
unsafe def trace_widget (w : widget.component tactic_state Empty) (text := "(widget)") : tactic Unit :=
  do 
