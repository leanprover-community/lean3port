...
instance : IsLawfulMonad Option :=
  { id_map := fun α x => Option.rec rfl (fun x => rfl) x, pure_bind := fun α β x f => rfl,
...
theorem Option.eq_none_of_is_none {α : Type u} : ∀ {o : Option α}, o.is_none → o = none
| none, h => rfl
