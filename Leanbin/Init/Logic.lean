...
[PrettyPrinter.parenthesize.input] (Command.declaration
     ...
     (Command.def
      "def"
      (Command.declId `Reflexive [])
      (Command.optDeclSig [] [])
      (Command.declValSimple ":=" (Term.forall "∀" [`x] [] "," (Init.Logic.«term_≺_» `x "≺" `x)) [])
      []
      []
      []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.def', expected 'Lean.Parser.Command.abbrev'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Term.forall "∀" [`x] [] "," (Init.Logic.«term_≺_» `x "≺" `x))
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Init.Logic.«term_≺_» `x "≺" `x)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Init.Logic.«term_≺_»', expected 'Init.Logic.term_≺_._@.Init.Logic._hyg.29'
...
[PrettyPrinter.parenthesize.input] (Command.declaration
     ...
     (Command.def
      "def"
      (Command.declId `Symmetric [])
      (Command.optDeclSig [] [])
      (Command.declValSimple
       ":="
       (Term.forall
        "∀"
        [(Term.strictImplicitBinder "⦃" [`x `y] [] "⦄")]
        []
        ","
        (Term.arrow (Init.Logic.«term_≺_» `x "≺" `y) "→" (Init.Logic.«term_≺_» `y "≺" `x)))
       [])
      []
      []
      []))
...
[PrettyPrinter.parenthesize.input] (Command.declaration
     ...
     (Command.def
      "def"
      (Command.declId `Transitive [])
      (Command.optDeclSig [] [])
      (Command.declValSimple
       ":="
       (Term.forall
        "∀"
        [(Term.strictImplicitBinder "⦃" [`x `y `z] [] "⦄")]
        []
        ","
        (Term.arrow
         (Init.Logic.«term_≺_» `x "≺" `y)
         "→"
         (Term.arrow (Init.Logic.«term_≺_» `y "≺" `z) "→" (Init.Logic.«term_≺_» `x "≺" `z))))
       [])
      []
      []
      []))
     ...
     (Command.def
      ...
      (Command.declValSimple
       ...
       (Term.forall
        ...
        []
        ","
        («term_∨_» (Init.Logic.«term_≺_» `x "≺" `y) "∨" (Init.Logic.«term_≺_» `y "≺" `x)))
       [])
      []
      []
      []))
...
[PrettyPrinter.parenthesize.input] (Command.declaration
     ...
     (Command.def
      "def"
      (Command.declId `Irreflexive [])
      (Command.optDeclSig [] [])
      (Command.declValSimple
       ":="
       (Term.forall "∀" [`x] [] "," («term¬_» "¬" (Init.Logic.«term_≺_» `x "≺" `x)))
       [])
      []
      []
      []))
      ...
      (Command.declValSimple
       ...
       (Term.forall
        ...
        (Term.arrow
         (Init.Logic.«term_≺_» `x "≺" `y)
         "→"
         (Term.arrow (Init.Logic.«term_≺_» `y "≺" `x) "→" («term_=_» `x "=" `y))))
       [])
      []
      []
      []))
...
[PrettyPrinter.parenthesize.input] (Command.declaration
     ...
     (Command.def
      "def"
      (Command.declId `InvImage [])
      (Command.optDeclSig
       [(Term.explicitBinder "(" [`f] [":" (Term.arrow `α "→" `β)] [] ")")]
       [(Term.typeSpec ":" (Term.arrow `α "→" (Term.arrow `α "→" (Term.prop "Prop"))))])
      (Command.declValSimple
       ":="
       (Term.fun
        "fun"
        (Term.basicFun
         ...
         []
         "=>"
         (Init.Logic.«term_≺_» (Term.app `f [`a₁]) "≺" (Term.app `f [`a₂]))))
       [])
      []
      []
      []))
     ...
     (Command.def
      ...
      (Command.declValSimple
       ...
       (Term.forall
        ...
        []
        ","
        («term_=_» (Init.Logic.f `a "*" `b) "=" (Init.Logic.f `b "*" `a)))
       [])
      []
      []
      []))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Init.Logic.f `b "*" `a)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Init.Logic.f', expected 'Init.Logic.f._@.Init.Logic._hyg.80'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declValSimple', expected 'Lean.Parser.Command.declValEqns'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declValSimple', expected 'Lean.Parser.Command.whereStructInst'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.def', expected 'Lean.Parser.Command.theorem'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.def', expected 'Lean.Parser.Command.opaque'
     ...
     (Command.def
      ...
      (Command.declValSimple
       ...
       (Term.forall
        ...
        ","
        («term_=_»
         (Init.Logic.f (Init.Logic.f `a "*" `b) "*" `c)
         "="
         (Init.Logic.f `a "*" (Init.Logic.f `b "*" `c))))
       [])
      []
      []
      []))
...
[PrettyPrinter.parenthesize.input] (Command.declaration
     ...
     (Command.def
      "def"
      (Command.declId `LeftIdentity [])
      (Command.optDeclSig [] [])
      (Command.declValSimple
       ":="
       (Term.forall "∀" [`a] [] "," («term_=_» (Init.Logic.f `one "*" `a) "=" `a))
       [])
      []
      []
      []))
...
[PrettyPrinter.parenthesize.input] (Command.declaration
     ...
     (Command.def
      "def"
      (Command.declId `RightIdentity [])
      (Command.optDeclSig [] [])
      (Command.declValSimple
       ":="
       (Term.forall "∀" [`a] [] "," («term_=_» (Init.Logic.f `a "*" `one) "=" `a))
       [])
      []
      []
      []))
     ...
     (Command.def
      ...
      (Command.declValSimple
       ...
       (Term.forall
        ...
        []
        ","
        («term_=_» (Init.Logic.f `a "*" (Init.Logic.inv `a "⁻¹")) "=" `one))
       [])
      []
      []
      []))
...
[PrettyPrinter.parenthesize] ...precedences are 51 >? 1024, (none,
     [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 50, term))
      (Init.Logic.f `a "*" (Init.Logic.inv `a "⁻¹"))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Init.Logic.f', expected 'Init.Logic.f._@.Init.Logic._hyg.80'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declValSimple', expected 'Lean.Parser.Command.declValEqns'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declValSimple', expected 'Lean.Parser.Command.whereStructInst'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.def', expected 'Lean.Parser.Command.theorem'
...
[PrettyPrinter.parenthesize.input] (Command.declaration
     ...
     (Command.def
      "def"
      (Command.declId `LeftCancelative [])
      (Command.optDeclSig [] [])
      (Command.declValSimple
       ":="
       (Term.forall
        ...
        ","
        (Term.arrow
         («term_=_» (Init.Logic.f `a "*" `b) "=" (Init.Logic.f `a "*" `c))
         "→"
         («term_=_» `b "=" `c)))
       [])
      []
...
[PrettyPrinter.parenthesize.input] (Command.declaration
     ...
     (Command.def
      "def"
      (Command.declId `RightCancelative [])
      (Command.optDeclSig [] [])
      (Command.declValSimple
       ":="
       (Term.forall
        ...
        ","
        (Term.arrow
         («term_=_» (Init.Logic.f `a "*" `b) "=" (Init.Logic.f `c "*" `b))
         "→"
         («term_=_» `a "=" `c)))
       [])
      []
...
[PrettyPrinter.parenthesize.input] (Command.declaration
     ...
     (Command.def
      "def"
      (Command.declId `LeftDistributive [])
      (Command.optDeclSig [] [])
      (Command.declValSimple
       ":="
       (Term.forall
        ...
        ","
        («term_=_»
         (Init.Logic.f `a "*" (Init.Logic.g `b "+" `c))
         "="
         (Init.Logic.g (Init.Logic.f `a "*" `b) "+" (Init.Logic.f `a "*" `c))))
       [])
      []
      []
      []))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Init.Logic.g (Init.Logic.f `a "*" `b) "+" (Init.Logic.f `a "*" `c))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Init.Logic.g', expected 'Init.Logic.g._@.Init.Logic._hyg.153'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declValSimple', expected 'Lean.Parser.Command.declValEqns'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declValSimple', expected 'Lean.Parser.Command.whereStructInst'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.def', expected 'Lean.Parser.Command.theorem'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.def', expected 'Lean.Parser.Command.opaque'
...
[PrettyPrinter.parenthesize.input] (Command.declaration
     ...
     (Command.def
      "def"
      (Command.declId `RightDistributive [])
      (Command.optDeclSig [] [])
      (Command.declValSimple
       ":="
       (Term.forall
        ...
        ","
        («term_=_»
         (Init.Logic.f (Init.Logic.g `a "+" `b) "*" `c)
         "="
         (Init.Logic.g (Init.Logic.f `a "*" `c) "+" (Init.Logic.f `b "*" `c))))
       [])
      []
      []
      []))
...
[PrettyPrinter.parenthesize.input] (Command.declaration
     ...
     (Command.theorem
      "theorem"
      (Command.declId `left_comm [])
      (Command.declSig
       []
       (Term.typeSpec
        ":"
        (Term.arrow
         (Term.app `Commutative [`f])
         "→"
         (Term.arrow (Term.app `Associative [`f]) "→" (Term.app `LeftCommutative [`f])))))
      (Command.declValSimple
       ":="
       (Term.fun
        "fun"
           ...
           (calc
            ...
            (calcStep
             («term_=_»
              ...
              (Init.Logic.f (Init.Logic.f `a "*" `b) "*" `c))
             ":="
             (Term.app `Eq.symm [(Term.app `hassoc [`a `b `c])]))
            [(calcStep
              («term_=_» (Term.hole "_") "=" (Init.Logic.f (Init.Logic.f `b "*" `a) "*" `c))
              ":="
              (Term.subst (Term.app `hcomm [`a `b]) "▸" [`rfl]))
             (calcStep
              («term_=_» (Term.hole "_") "=" (Init.Logic.f `b "*" (Init.Logic.f `a "*" `c)))
              ":="
              (Term.app `hassoc [`b `a `c]))])))))
       [])
      []
      []))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      («term_=_» (Term.hole "_") "=" (Init.Logic.f `b "*" (Init.Logic.f `a "*" `c)))
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Init.Logic.f `b "*" (Init.Logic.f `a "*" `c))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Init.Logic.f', expected 'Init.Logic.f._@.Init.Logic._hyg.80'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.basicFun', expected 'Lean.Parser.Term.matchAlts'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.basicFun', expected 'Lean.Parser.Term.matchAlts'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declValSimple', expected 'Lean.Parser.Command.declValEqns'
        ...
        fun
          a b c
            ...
            calc
              ...
              _ = b * a * c := hcomm a b ▸ rfl _ = b * a * c := hassoc b a c
      ...
      (Command.declSig
       ...
       (Term.typeSpec
        ...
        (Term.arrow
         (Term.app `Commutative [`f])
         "→"
         (Term.arrow (Term.app `Associative [`f]) "→" (Term.app `RightCommutative [`f])))))
      (Command.declValSimple
       ":="
       (Term.fun
        "fun"
           ...
           (calc
            ...
            (calcStep
             («term_=_»
              ...
              (Init.Logic.f `a "*" (Init.Logic.f `b "*" `c)))
             ":="
             (Term.app `hassoc [`a `b `c]))
            [(calcStep
              («term_=_» (Term.hole "_") "=" (Init.Logic.f `a "*" (Init.Logic.f `c "*" `b)))
              ":="
              (Term.subst (Term.app `hcomm [`b `c]) "▸" [`rfl]))
             (calcStep
              («term_=_» (Term.hole "_") "=" (Init.Logic.f (Init.Logic.f `a "*" `c) "*" `b))
              ":="
              (Term.app `Eq.symm [(Term.app `hassoc [`a `c `b])]))])))))
       [])
      []
      []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.abbrev'
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023,
     term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" (Term.app `hassoc [`a `c `b]) ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
      `Eq.symm
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none,
     [anonymous]) <=? (some 1022, term)
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      («term_=_» (Term.hole "_") "=" (Init.Logic.f (Init.Logic.f `a "*" `c) "*" `b))
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Init.Logic.f (Init.Logic.f `a "*" `c) "*" `b)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Init.Logic.f', expected 'Init.Logic.f._@.Init.Logic._hyg.80'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.basicFun', expected 'Lean.Parser.Term.matchAlts'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.basicFun', expected 'Lean.Parser.Term.matchAlts'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declValSimple', expected 'Lean.Parser.Command.declValEqns'
        ...
        fun
          a b c
            ...
            calc
              ...
              _ = a * c * b := hcomm b c ▸ rfl _ = a * c * b := Eq.symm hassoc a c b
