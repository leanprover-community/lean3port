...
theorem zero_le_ofNat (n : ℕ) : 0 ≤ ofNat n :=
  @le.intro _ _ n (by rw [Int.zero_add, Int.natCast_eq_ofNat])
...
theorem natAbs_ofNat' (n : ℕ) : natAbs (ofNat n) = n :=
  rfl
#align int.nat_abs_of_nat_core Int.natAbs_ofNat'
-/

#print Int.natAbs_negSucc /-
theorem natAbs_negSucc (n : ℕ) : natAbs (negSucc n) = Nat.succ n :=
  rfl
#align int.nat_abs_of_neg_succ_of_nat Int.natAbs_negSucc
-/

#print Int.natAbs_add_of_nonneg /-
protected theorem natAbs_add_of_nonneg :
...
#print Int.natAbs_add_of_nonpos /-
protected theorem natAbs_add_of_nonpos :
...
protected theorem natAbs_bit0 : ∀ a : Int, natAbs (bit0 a) = bit0 (natAbs a)
  | of_nat n => Int.natAbs_add_of_nonneg (zero_le_ofNat n) (zero_le_ofNat n)
  | neg_succ_of_nat n => Int.natAbs_add_of_nonpos (negSucc_lt_zero n) (negSucc_lt_zero n)
...
protected theorem natAbs_bit1_nonneg {a : Int} (h : 0 ≤ a) : natAbs (bit1 a) = bit1 (natAbs a) :=
  show natAbs (bit0 a + 1) = bit0 (natAbs a) + natAbs 1 by
    rw [Int.natAbs_add_of_nonneg (Int.bit0_nonneg h) (le_of_lt Int.zero_lt_one), Int.natAbs_bit0]
