...
/- warning: nat.div_eq_of_lt clashes with nat.div_eq_zero -> Nat.div_eq_of_lt
Case conversion may be inaccurate. Consider using '#align nat.div_eq_of_lt Nat.div_eq_of_ltₓ'. -/
...
/- warning: nat.mul_div_mul clashes with nat.mul_div_mul_left -> Nat.mul_div_mul_left
Case conversion may be inaccurate. Consider using '#align nat.mul_div_mul Nat.mul_div_mul_leftₓ'. -/
